...
public class Register extends AppCompatActivity {
    ...
    private void sendIdToServer(final String token) {
        ...
        StringRequest req = new StringRequest(Request.Method.POST, Constans.REGISTER_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.trim().equalsIgnoreCase("success")) {
                            ...
                            Toast.makeText(Register.this, "Choose a different email", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
